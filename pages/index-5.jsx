            ...
            <Layout>
                <section className="pb-8 bg-top bg-cover bg-no-repeat relative -mt-24 pt-24" style={{"backgroundImage":"url('assets/imgs/backgrounds/intersect.svg')"}}>
                    <div className="hidden md:block absolute top-0 left-0 mt-32">
                        <img className="h-64 lg:h-80 jump" src="/imgs/illustrations/at_the_park.svg" alt="Monst" />
                    </div>
                    <div className="hidden md:block absolute top-0 right-0 mt-32">
                        <img className="h-64 lg:h-80 jump" src="/imgs/illustrations/delivered.svg" alt="Monst" />
                    </div>
                    ...
                    <div className="container py-12 mx-auto">
                        <div className="flex flex-wrap">
                            ...
                            <div className="w-full md:w-1/2 px-3 order-0 md:order-1 mb-12 md:mb-0 wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                <img className="sm:max-w-sm lg:max-w-full mx-auto" src="/imgs/illustrations/podcast.svg" alt="Monst" />
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container">
                        <div className="flex flex-wrap lg:flex-nowrap">
                            <div className="flex flex-wrap lg:max-w-sm mx-auto">
                                <img className="jump sm:max-w-sm lg:max-w-full mx-auto wow animate__animated animate__fadeIn" data-wow-delay=".5s" src="/imgs/illustrations/tasks.svg" alt="Monst" />
                            </div>
                            <div className="w-full lg:w-auto">
