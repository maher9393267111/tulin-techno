    ...
    return (
        <>
            ...
            >
                ...
                <SwiperSlide>
                    <img className="rounded" src="/imgs/placeholders/img-6.png" alt="Monst" />
                </SwiperSlide>
                <SwiperSlide>

                    <img className="rounded" src="/imgs/placeholders/img-7.png" alt="Monst" />
                </SwiperSlide>
                <SwiperSlide>

                    <img className="rounded" src="/imgs/placeholders/img-8.png" alt="Monst" />
                </SwiperSlide>
            </Swiper>
